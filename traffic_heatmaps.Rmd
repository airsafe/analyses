---
title: "AirSafe.com traffic spikes heat maps May 2006 to 30 October 2018"
author: "Todd Curtis"
...
Between May 2006 and July 2018, significant traffic spikes on AirSafe.com, specifically days where the estimated number of visits to the site exceeded the average number of visit in a 28-day comparison period by more than two standard deviations, frequently occurred within seven days of widely reported events involving airline safety and security, but there were a number of spikes that occurred that were unrelated to a recent safety or security event. 
...
###Data###
The key source of data were the AirSafe.com session data provided by Google Analytics. The period covered by this study was from 6 April 2006 to 13 July 2018.
...
Note that in the dates covered in the original analysis in 2015, there were 266 spike days. The data downloaded for this analysis, which had values for the number of sessions that was universally lower than the session values for the comparative days from the original analysis, had three fewer spike days (263 vs. 266). 

This updated analysis included 972 additional days, which also included 53 spike days. These maximum standard deviation during this 53 spike days was 23.7. That compares with a maximum of 74.3 over the entire range of days.
